...
describe("panel", () => {
  const wrapper = mount(
    <Panel>
      <PanelHeader>
        <PanelTitle>Test test</PanelTitle>
      </PanelHeader>
      <PanelBody>Test test test</PanelBody>
    </Panel>,
  )
  ...
  it("should render its children", () => {
    ...
    const child2 = <PanelBody>Test test test</PanelBody>
  ...
  it("closes and opens when clicked", () => {
    ...
    // Simulate open
    // wrapper.find(PanelHeader).simulate("click")
    // expect(wrapper.find(".panel-body").getDOMNode().style.height).toEqual(
    //   "auto",
    // )
