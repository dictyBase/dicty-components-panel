...
var HeaderDiv = _styledComponents2.default.div(_templateObject, function (props) {
  ...
  return props.theme.headerBackgroundColor ? props.theme.headerBackgroundColor : "#15317e";
}, function (props) {
...
var PanelHeader = function (_Component) {
  ...
  function PanelHeader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PanelHeader.__proto__ || Object.getPrototypeOf(PanelHeader)).call.apply(_ref, [this].concat(args))), _this), _this.renderChildren = function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        HeaderDiv,
        {
          collapse: collapse,
          onClick: clickFunc,
          style: _extends({ borderBottom: collapse && "0px none #ddd" }, style) },
        this.renderChildren()
      );
    }
  }]);
