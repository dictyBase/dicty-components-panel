...
var PanelBody = function (_Component) {
  ...
  function PanelBody() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PanelBody.__proto__ || Object.getPrototypeOf(PanelBody)).call.apply(_ref, [this].concat(args))), _this), _this.close = function () {
      ...
      _this.body.addEventListener("transitionend", _this.handleTransitionend, false);
      ...
      if (e.propertyName == "height" && open) {
        ...
        _this.body.style.height = "auto";
        _this.body.removeEventListener("transitionend", _this.handleTransitionend, false);
      }
